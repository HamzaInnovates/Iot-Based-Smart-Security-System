...
__all__ = [
    'Speech_Max_Pron_Length', 'ISpeechPhoneConverter',
    'SSTTDictation', 'SVEVoiceChange', 'DISPID_SPARecoResult',
    'DISPID_SpeechRecoContextEvents', 'SPPS_RESERVED1',
    'DISPID_SADefaultFormat', 'DISPID_SPAStartElementInResult',
    'SPAO_NONE', 'DISPID_SRAudioInput', 'DISPID_SPAs_NewEnum',
    'SREBookmark', 'SVP_15', 'SREInterference',
    'DISPID_SRGCmdLoadFromMemory', 'SDTAll', 'DISPID_SAStatus',
    'SpeechTokenIdUserLexicon', 'SAFT32kHz16BitMono',
    'DISPID_SVSInputWordLength', 'SpeechStreamSeekPositionType',
    'DISPID_SRGetPropertyString', 'SPDKL_DefaultLocation',
    'DISPID_SBSRead', 'SPSVerb', 'DISPID_SPPBRestorePhraseFromMemory',
    'SPRST_INACTIVE_WITH_PURGE', 'ISpeechRecoContext',
    'eLEXTYPE_PRIVATE14', 'SAFTCCITT_ALaw_22kHzStereo',
    'SpStreamFormatConverter', 'SAFTCCITT_ALaw_44kHzStereo',
    'ISpeechPhraseRule', 'DISPID_SPRules_NewEnum',
    'SAFTGSM610_11kHzMono', 'eLEXTYPE_PRIVATE15',
    'DISPID_SCSBaseStream', 'SAFTADPCM_11kHzStereo',
    'ISpeechPhraseRules', 'SRSActiveAlways',
    'DISPID_SPIAudioSizeTime', 'DISPID_SPEEngineConfidence',
    'eLEXTYPE_USER_SHORTCUT', 'SPVOICESTATUS',
    'DISPID_SpeechPhraseReplacement', 'SECNormalConfidence',
    'SPPS_Verb', 'SAFT24kHz8BitStereo',
    'DISPID_SpeechPhraseReplacements', 'SDA_Consume_Leading_Spaces',
    'ISpeechVoiceStatus', 'SpeechVoiceCategoryTTSRate',
    'eLEXTYPE_RESERVED6', 'SPRST_ACTIVE_ALWAYS', 'SpSharedRecognizer',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SPRuleNumberOfElements',
    'SpVoice', 'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SP_VISEME_4',
    'SPEI_REQUEST_UI', 'SPPS_RESERVED3', 'SPSNoun',
    'DISPID_SABufferNotifySize', 'SITooFast', 'SPDKL_LocalMachine',
    'DISPID_SDKSetStringValue', 'DISPID_SGRSTPropertyId',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPEI_PROPERTY_STRING_CHANGE',
    'DISPID_SOTCategory', 'ISpeechObjectToken', 'DISPID_SOTId',
    'SPPS_RESERVED4', 'SREAllEvents', 'SAFT48kHz8BitStereo',
    'DISPID_SPRuleId', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SRRAudioFormat', 'DISPID_SRRRecoContext',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SDTReplacement',
    'SRAExport', 'ISpeechPhraseReplacements', 'SVP_12', 'SLODynamic',
    'SpeechPartOfSpeech', 'DISPID_SpeechAudioFormat',
    'SpeechFormatType', 'ISpeechLexiconWords', 'DISPID_SDKEnumValues',
    'DISPID_SVSkip', 'STCInprocServer', 'DISPID_SABufferInfo',
    'SECFDefault', 'SPGRAMMARWORDTYPE', 'SSSPTRelativeToStart',
    'ISpeechResourceLoader', 'SAFT8kHz16BitStereo', 'ISpPhrase',
    'DISPID_SpeechAudio', 'eLEXTYPE_PRIVATE20', 'SPEI_SOUND_START',
    'SPADAPTATIONRELEVANCE', 'SpeechEngineProperties',
    'ISpRecoGrammar', 'SGSEnabled', 'SP_VISEME_6', 'SDTPronunciation',
    'SpeechAudioVolume', 'DISPID_SOTMatchesAttributes',
    'SpeechRetainedAudioOptions', 'DISPID_SpeechMemoryStream',
    'SFTSREngine', 'DISPID_SVDisplayUI',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SLGenerationId',
    'DISPID_SLWs_NewEnum', 'SpAudioFormat',
    'DISPID_SLRemovePronunciation', 'SPPS_Noun',
    'DISPID_SpeechRecoResult', 'DISPID_SpeechVoiceEvent',
    'DISPID_SLPPartOfSpeech', 'ISpeechPhraseInfoBuilder',
    '__MIDL_IWinTypes_0009', 'SAFT11kHz8BitMono', 'SSFMCreate',
    'DISPID_SABIBufferSize', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SGRSAddSpecialTransition', 'SPEI_SR_PRIVATE',
    'SpShortcut', 'SP_VISEME_19',
    'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SRCEInterference', 'DISPID_SGRsCommit',
    'DISPID_SGRSTType', 'SVP_6',
    'SpeechPropertyHighConfidenceThreshold',
    'SAFTCCITT_uLaw_22kHzMono', 'SAFTDefault', 'SINoise',
    'SpeechEngineConfidence', 'DISPID_SRRGetXMLErrorInfo',
    'SpeechBookmarkOptions', 'DISPID_SVGetProfiles',
    'SpeechVisemeType', 'ISpeechPhraseElement',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SPCPhoneToId',
    'ISpeechRecoResult', 'SGRSTTRule', 'DISPID_SRCVoicePurgeEvent',
    'SAFT12kHz16BitStereo', 'SVP_8', 'SPCT_SUB_COMMAND',
    'eLEXTYPE_PRIVATE9', 'SPRST_NUM_STATES',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SPIStartTime',
    'DISPID_SVSLastBookmarkId', 'DISPID_SAFType', 'SAFT12kHz8BitMono',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SDKGetStringValue', 'ISpRecognizer', 'SPLO_STATIC',
    'SPWT_LEXICAL', 'eLEXTYPE_RESERVED9', 'DISPID_SDKSetBinaryValue',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SPERequiredConfidence',
    'DISPID_SVEAudioLevel', 'ISpeechWaveFormatEx',
    'SpeechCategoryAppLexicons', 'DISPID_SLPsItem',
    'SPEI_END_SR_STREAM', 'SP_VISEME_18', 'SVSFlagsAsync',
    'ISpRecoContext', 'DISPID_SPRsCount', 'DISPID_SASNonBlockingIO',
    'DISPID_SRRecognizer', 'DISPID_SWFEChannels',
    'DISPID_SGRs_NewEnum', 'SRTAutopause', 'DISPID_SDKOpenKey',
    'SWPUnknownWordPronounceable', 'SPEI_RESERVED5',
    'SAFT32kHz8BitMono', 'ISpeechRecoResultDispatch', 'SVP_14',
    'SAFT24kHz16BitStereo', 'DISPID_SRRAudio', 'SVSFParseSapi',
    'IEnumSpObjectTokens', 'SPCATEGORYTYPE', 'SVEBookmark',
    'SAFTCCITT_ALaw_8kHzMono', 'SSSPTRelativeToEnd', 'SPFM_NUM_MODES',
    'SAFTCCITT_uLaw_44kHzMono', 'SAFTCCITT_uLaw_44kHzStereo',
    'ISpeechPhraseInfo', 'SPFILEMODE', 'SpeechVoiceEvents',
    'SAFT44kHz16BitStereo', 'SITooQuiet', 'eLEXTYPE_PRIVATE18',
    'DISPID_SASetState', 'DISPID_SRCRequestedUIType', 'SVPNormal',
    'SPXMLRESULTOPTIONS', 'SPRS_ACTIVE', 'DISPID_SRGetFormat',
    'DISPID_SpeechGrammarRules', 'SAFT48kHz8BitMono',
    'SECFIgnoreWidth', 'DISPID_SPIGetDisplayAttributes',
    'DISPID_SPEs_NewEnum', 'DISPID_SVEBookmark', 'SVP_19',
    'SpeechGrammarTagDictation',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SAVolume',
    'SRAONone', 'SpeechAudioFormatType', 'DISPID_SRGetPropertyNumber',
    'DISPID_SWFESamplesPerSec', 'SAFT48kHz16BitStereo',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SPRFirstElement', 'SAFTText',
    'DISPID_SPEAudioSizeTime', 'SPLOADOPTIONS', 'ISpGrammarBuilder',
    'STCAll', 'eLEXTYPE_PRIVATE5', 'SpObjectTokenCategory',
    'DISPID_SRGCmdSetRuleState', 'DISPID_SRRSaveToMemory',
    'DISPIDSPTSI_SelectionOffset',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPWORDPRONUNCIATION',
    'SVSFNLPMask', 'DISPID_SVPriority', 'ISpeechXMLRecoResult',
    'SP_VISEME_17', 'SPSHORTCUTPAIRLIST', 'ISpeechLexicon',
    'SpFileStream', 'SPWF_INPUT', 'SPAR_Medium', 'eLEXTYPE_PRIVATE6',
    'SPPS_RESERVED2', 'DISPIDSPTSI_ActiveOffset',
    'SAFTNonStandardFormat', 'SRTReSent', 'SAFT22kHz8BitStereo',
    'DISPID_SRCResume', 'DISPID_SGRSAddWordTransition',
    'SpMMAudioOut', 'STCInprocHandler', 'SVP_1', 'DISPID_SRProfile',
    'SPAO_RETAIN_AUDIO', 'SPSERIALIZEDPHRASE', 'SRSEIsSpeaking',
    'SAFT8kHz8BitStereo', 'SpeechAllElements', 'DISPID_SRIsShared',
    'SpeechCategoryAudioOut', 'SP_VISEME_13', 'SPCT_DICTATION',
    'SPEI_RECO_STATE_CHANGE', 'SITooSlow', 'ISpSerializeState',
    'SpeechWordType', 'ISpNotifySink', 'DISPID_SDKCreateKey',
    'SPAR_Low', 'ISpeechRecognizer', 'SP_VISEME_16',
    'SPSERIALIZEDRESULT', 'DISPID_SpeechAudioStatus',
    'DISPID_SVVolume', 'DISPID_SLGetGenerationChange',
    'DISPID_SPACommit', 'SAFT16kHz16BitMono',
    'SpeechCategoryRecognizers', 'SpeechRuleState',
    'SPEI_SR_BOOKMARK', 'STSF_CommonAppData', 'SpeechInterference',
    'eLEXTYPE_PRIVATE3', 'SPCONTEXTSTATE', 'SRAORetainAudio',
    'DISPID_SGRSRule', 'SPSFunction', 'SGDSActiveWithAutoPause',
    'SPEI_SOUND_END', 'DISPID_SABIMinNotification',
    'DISPID_SpeechObjectTokens', 'SpeechAudioFormatGUIDWave',
    'SAFTGSM610_44kHzMono', 'DISPID_SWFEBlockAlign',
    'DISPID_SpeechLexiconPronunciation', 'ISpeechAudioFormat',
    'SP_VISEME_15', 'SAFT22kHz8BitMono', 'STCRemoteServer',
    'SPCS_ENABLED', 'Speech_StreamPos_RealTime',
    'DISPID_SOTGetDescription', 'DISPID_SpeechPhraseElements',
    'DISPID_SLPPhoneIds', 'SGRSTTWildcard', 'DISPID_SRIsUISupported',
    'SRARoot', 'SGSDisabled', 'DISPID_SRSetPropertyNumber', 'SVP_13',
    'SVSFNLPSpeakPunc', 'DISPID_SVSCurrentStreamNumber', 'SRSActive',
    'DISPID_SPEDisplayText', 'DISPID_SPPsCount',
    'DISPID_SpeechPhraseRule', 'ISpeechPhraseProperty', 'ISpLexicon',
    'SPDATAKEYLOCATION', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SOTCDefault', 'DISPID_SLWLangId', 'SPAS_PAUSE',
    'SPSTREAMFORMATTYPE', 'ISpeechDataKey', 'SITooLoud',
    'SSTTWildcard', 'DISPID_SOTSetId', 'eLEXTYPE_PRIVATE12',
    'DISPID_SVVoice', 'SpeechTokenShellFolder',
    'SPEI_START_INPUT_STREAM', 'DISPID_SGRClear', 'SRTEmulated',
    'SPAR_High', 'SPFM_OPEN_READWRITE', 'SVSFPersistXML',
    'eLEXTYPE_RESERVED4', 'eLEXTYPE_PRIVATE1', 'DISPID_SVSLastResult',
    'DISPID_SRCEPropertyStringChange', 'ISpRecoResult',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SpeechWaveFormatEx',
    'SAFT48kHz16BitMono', 'SSFMOpenReadWrite',
    'ISpeechAudioBufferInfo', 'DISPID_SLWsItem', 'DISPID_SOTCId',
    'SpeechRecoContextState', 'SWTDeleted', 'ISpPhraseAlt',
    'DISPID_SREmulateRecognition', 'ISpEventSource',
    'SpeechTokenKeyAttributes', 'DISPID_SGRSTPropertyValue',
    'ISpStreamFormat', 'DISPID_SOTsCount',
    'DISPID_SRSetPropertyString', 'SREHypothesis',
    'SAFT44kHz8BitStereo', 'DISPID_SPRuleConfidence', 'SPPS_Modifier',
    'SP_VISEME_10', 'DISPID_SRGReset',
    'DISPID_SRGCmdLoadFromResource', 'SPBOOKMARKOPTIONS',
    'DISPID_SOTCreateInstance', 'DISPID_SGRInitialState',
    'DISPID_SRRSetTextFeedback', 'SRTSMLTimeout', 'SP_VISEME_21',
    'SAFTCCITT_uLaw_11kHzMono', 'SPBO_TIME_UNITS',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SPRuleFirstElement', 'SPSModifier',
    'DISPID_SVEventInterests', 'SAFTADPCM_8kHzMono', 'SBONone',
    'SPEI_RESERVED6', 'ISpeechGrammarRuleState', 'SVP_5',
    'SPEI_SR_AUDIO_LEVEL', 'SpeechGrammarRuleStateTransitionType',
    'SPDKL_CurrentUser', 'SpeechStreamFileMode',
    'DISPID_SPEDisplayAttributes', 'DISPID_SGRName',
    'SAFTNoAssignedFormat', 'SpeechGrammarTagWildcard',
    'DISPID_SVEEnginePrivate', 'DISPID_SpeechRecoResult2',
    'eLEXTYPE_USER', 'SpeechMicTraining', 'DISPID_SGRAddResource',
    'ISpeechLexiconWord', 'SpWaveFormatEx', 'DISPID_SpeechBaseStream',
    'SREPrivate', 'DISPID_SRRTStreamTime', 'SpMMAudioIn',
    'SAFT12kHz8BitStereo', 'SPPS_Interjection', 'SPPHRASE',
    'SAFT44kHz8BitMono', 'SAFT32kHz8BitStereo',
    'SpeechEmulationCompareFlags', 'ISpeechGrammarRules',
    'ISpeechVoice', 'DISPID_SRRTLength', 'SVEEndInputStream',
    'SRATopLevel', 'SPRULESTATE', 'SGRSTTDictation',
    'SPRECOCONTEXTSTATUS', 'SVP_11', 'SpeechTokenContext',
    'SpeechUserTraining', 'SPINTERFERENCE_NOISE',
    'SAFTADPCM_8kHzStereo', 'SPEI_MIN_TTS', 'ISpObjectTokenCategory',
    'DISPID_SpeechVoiceStatus', 'DISPID_SRCESoundEnd',
    'DISPID_SRRSpeakAudio', 'SRSEDone', 'DISPID_SWFEExtraData',
    'SpeechDiscardType', 'SRERecognition', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SPRulesCount', 'ISpObjectToken', 'SP_VISEME_3',
    'DISPID_SVSpeakStream', 'SDTLexicalForm',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SpeechRecoContext',
    'SAFTADPCM_22kHzStereo', 'SPWORDLIST', 'SPEI_RECOGNITION',
    'eLEXTYPE_PRIVATE19', 'SLTUser', 'SpeechRecognitionType',
    'SECHighConfidence', 'SPEI_VOICE_CHANGE',
    'SpeechCategoryPhoneConverters', 'SAFTCCITT_ALaw_44kHzMono',
    'SSFMOpenForRead', 'SPINTERFERENCE', 'DISPID_SOTCEnumerateTokens',
    'SSTTTextBuffer', 'SPCS_DISABLED', 'SGPronounciation',
    'ISpeechAudioStatus', 'SPTEXTSELECTIONINFO', 'STSF_AppData',
    'SREPhraseStart', 'SPEI_INTERFERENCE', 'ISpRecoGrammar2',
    'DISPID_SOTIsUISupported', 'DISPID_SPRText', 'DISPID_SRStatus',
    'DISPID_SRCEAdaptation', 'DISPID_SASFreeBufferSpace',
    'DISPID_SpeechLexiconWord', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SPEAudioStreamOffset', 'SVEStartInputStream',
    'SAFTADPCM_44kHzMono', 'SDKLLocalMachine',
    'SpeechTokenValueCLSID', 'DISPID_SASCurrentDevicePosition',
    'SpeechVoicePriority', 'eLEXTYPE_PRIVATE4', 'SPGS_ENABLED',
    'ISpStream', 'ISpRecoCategory', 'SDTAudio', 'DISPID_SOTDataKey',
    'SPEI_PHONEME', 'DISPID_SRRTOffsetFromStart',
    'DISPID_SPEActualConfidence', 'SRSInactiveWithPurge',
    'SRERecoOtherContext', 'DISPID_SPAPhraseInfo',
    'SpeechCategoryAudioIn', 'SSSPTRelativeToCurrentPosition',
    'DISPID_SPERetainedStreamOffset', 'SpeechWordPronounceable',
    'DISPIDSPTSI_SelectionLength', 'SPAS_RUN', 'SRTStandard',
    'DISPID_SOTGetAttribute', 'DISPID_SDKDeleteKey', 'SVP_16',
    'SGRSTTTextBuffer', 'eLEXTYPE_PRIVATE7',
    'SAFTCCITT_uLaw_8kHzStereo', 'SPEI_RESERVED2', 'SWTAdded',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SPERetainedSizeBytes',
    'SpNotifyTranslator', 'DISPID_SRCVoice', 'SVP_3',
    '_RemotableHandle', 'SAFT8kHz16BitMono', 'DISPID_SRRTimes',
    'DISPID_SVEVoiceChange', 'SASStop', 'typelib_path',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'ISpeechMemoryStream',
    'DISPID_SRGCommit', 'DISPID_SRCPause', 'DISPID_SPELexicalForm',
    'SGDSActiveUserDelimited', 'DISPID_SpeechXMLRecoResult',
    'IInternetSecurityManager', 'SVSFPurgeBeforeSpeak', 'SASClosed',
    'DISPID_SRCAudioInInterferenceStatus', 'SPDKL_CurrentConfig',
    'SpInProcRecoContext', 'SAFT22kHz16BitMono',
    'DISPID_SpeechPhraseInfo', 'SGLexicalNoSpecialChars',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SP_VISEME_0',
    'DISPID_SDKEnumKeys', 'SWPKnownWordPronounceable',
    'eLEXTYPE_PRIVATE11', 'SpeechVoiceSpeakFlags',
    'SAFT32kHz16BitStereo', 'SPSLMA', 'SSFMCreateForWrite',
    'tagSPPROPERTYINFO', 'SpeechPropertyResourceUsage',
    'Speech_StreamPos_Asap', 'SREAdaptation', 'DISPID_SRGRecoContext',
    'SPRECORESULTTIMES', 'SBOPause', 'SREFalseRecognition',
    'ISpeechLexiconPronunciation', 'DISPID_SpeechGrammarRule',
    'SpTextSelectionInformation', 'DISPID_SpeechLexicon',
    'eLEXTYPE_PRIVATE17', 'DISPID_SGRSTs_NewEnum',
    'SPEVENTSOURCEINFO', 'ISpeechMMSysAudio', 'ISpRecognizer2',
    'eWORDTYPE_ADDED', 'SVP_9', 'SVP_21', 'DISPID_SVGetAudioOutputs',
    'SpeechVisemeFeature', 'SPGRAMMARSTATE',
    'ISpeechPhraseAlternates', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SPIProperties', 'SVP_4', 'ISpShortcut',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SAFGetWaveFormatEx',
    'eLEXTYPE_PRIVATE2', 'SPAUDIOSTATE', 'DISPID_SPEsItem',
    'DISPID_SWFEFormatTag', 'ISpDataKey',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SASState',
    'SVSFIsFilename', 'DISPID_SVSLastBookmark', 'ISpeechObjectTokens',
    'DISPID_SRRGetXMLResult', 'SPEI_FALSE_RECOGNITION', 'SP_VISEME_8',
    'SPSSuppressWord', 'SPAR_Unknown', 'SpeechPropertyAdaptationOn',
    'SVP_2', 'SPEI_RESERVED1', 'SPWORDTYPE', 'SGDSActive',
    'SPGS_EXCLUSIVE', 'SpeechGrammarState', 'DISPID_SLPs_NewEnum',
    'DISPID_SRCEFalseRecognition', 'DISPID_SVEStreamEnd',
    'SREStateChange', 'SPSHORTCUTTYPE', 'SVSFIsXML',
    'SpeechRegistryLocalMachineRoot', 'ISpNotifySource',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SRCEHypothesis',
    'SECFIgnoreKanaType', 'DISPID_SVSInputSentencePosition',
    'ISpeechCustomStream', 'DISPID_SPIAudioSizeBytes',
    'SpeechPropertyLowConfidenceThreshold',
    'DISPID_SPRuleEngineConfidence', 'SPRS_ACTIVE_USER_DELIMITED',
    'SpeechCategoryRecoProfiles', 'DISPID_SPIEnginePrivateData',
    'SPAUDIOSTATUS', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SpeechPhraseRules', 'DISPID_SGRId',
    'DISPID_SGRsCommitAndSave', 'SPPARTOFSPEECH',
    'SAFT11kHz16BitStereo', 'DISPID_SPILanguageId', 'DISPID_SPAsItem',
    'DISPID_SRDisplayUI', 'STCLocalServer', 'DISPID_SOTRemove',
    'SpeechTokenKeyFiles', 'SAFT22kHz16BitStereo',
    'SpNullPhoneConverter', 'DISPID_SRCEEndStream',
    'SPFM_OPEN_READONLY', 'DISPID_SOTGetStorageFileName',
    'DISPID_SVGetVoices', 'SPWT_PRONUNCIATION', 'DISPID_SPIRule',
    'DISPID_SGRSTRule', 'DISPID_SRCEStartStream',
    'SRADefaultToActive', 'SPEI_PHRASE_START',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SLWType',
    'SAFTCCITT_ALaw_11kHzMono', 'SPEI_START_SR_STREAM',
    'SDTAlternates', 'DISPID_SLWWord', 'SpSharedRecoContext',
    'SPVPRI_OVER', 'SRERequestUI', 'SpCompressedLexicon',
    'DISPID_SRRAlternates', 'SP_VISEME_1', 'SpeechAddRemoveWord',
    'SPSEMANTICERRORINFO', 'ISpPhoneticAlphabetConverter',
    'SRTExtendableParse', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SLPLangId', 'SPBO_AHEAD', 'ISpeechRecoResultTimes',
    'DISPID_SWFEAvgBytesPerSec', 'eLEXTYPE_RESERVED7',
    'SPEI_SR_RETAINEDAUDIO', 'SDTDisplayText', 'SINoSignal',
    'SAFTCCITT_uLaw_11kHzStereo', 'DISPID_SPPConfidence',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'ISpRecoContext2', 'DISPID_SPIGetText',
    'DISPID_SpeechGrammarRuleState', 'SAFT11kHz8BitStereo',
    'DISPID_SRCEEnginePrivate', 'Speech_Max_Word_Length',
    'DISPID_SOTsItem', 'SpeechRecoProfileProperties',
    'DISPID_SGRSTText', 'SVSFIsNotXML', 'DISPID_SLPsCount',
    'DISPID_SRCState', 'SVF_None', 'ISpeechRecoGrammar',
    'SDKLCurrentConfig', 'eLEXTYPE_PRIVATE16', 'SpMemoryStream',
    'SPBO_PAUSE', '_ISpeechRecoContextEvents', 'DISPID_SPRs_NewEnum',
    'SECLowConfidence', 'DISPID_SAFGuid', 'STSF_FlagCreate',
    'STSF_LocalAppData', 'SP_VISEME_20', 'DISPID_SVPause',
    'DISPID_SMSADeviceId', 'SPEI_MIN_SR', 'DISPID_SRCESoundStart',
    'DISPID_SpeechFileStream', 'SpPhraseInfoBuilder',
    'ISpeechObjectTokenCategory',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SpeechPhraseAlternates', 'SPCT_SLEEP', 'SPLO_DYNAMIC',
    'ISpeechRecognizerStatus', 'DISPID_SVSRunningState',
    'DISPID_SRCreateRecoContext', 'DISPID_SVAlertBoundary',
    'SPEI_END_INPUT_STREAM', 'SpPhoneConverter',
    'DISPID_SPPEngineConfidence', 'SVSFParseMask', 'SGRSTTEpsilon',
    'DISPID_SRCEAudioLevel', 'DISPID_SpeechDataKey',
    'DISPID_SPIReplacements', 'SVP_17',
    'DISPID_SRCCreateResultFromMemory', 'DISPID_SPRuleName',
    'eLEXTYPE_PRIVATE8', 'SP_VISEME_7', 'DISPID_SRSAudioStatus',
    'SPRST_INACTIVE', 'DISPID_SGRsFindRule', 'DISPID_SPIElements',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SpeechLexiconProns',
    'SAFT16kHz8BitMono', 'DISPID_SLGetPronunciations',
    'ISpeechPhraseElements', 'SVPAlert', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SDKSetLongValue', 'SAFTADPCM_44kHzStereo',
    'ISpPhoneticAlphabetSelection', 'SpeechDisplayAttributes',
    'SDKLDefaultLocation', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SFSClose', 'DISPID_SRCEPhraseStart', 'DISPID_SVRate',
    'DISPID_SRGIsPronounceable', 'SVP_0',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SPISaveToMemory', 'DISPID_SRGId',
    'IInternetSecurityMgrSite', 'SPPHRASERULE',
    'DISPID_SVAudioOutputStream', 'SAFT44kHz16BitMono',
    'SpeechLexiconType', 'DISPID_SpeechCustomStream',
    'SpeechDictationTopicSpelling', 'SPPS_Function', 'SVEPrivate',
    'DISPID_SPPFirstElement', 'DISPID_SPRuleChildren',
    'SpCustomStream', 'SPEI_TTS_PRIVATE', 'eLEXTYPE_PRIVATE13',
    'SPEI_TTS_BOOKMARK', 'DISPID_SFSOpen', 'SDTRule',
    'DISPID_SPPValue', 'SVEViseme', 'DISPID_SGRAddState',
    'DISPID_SBSSeek', 'SPPS_SuppressWord', 'SDA_One_Trailing_Space',
    'SPFM_CREATE_ALWAYS', 'ISequentialStream', 'DISPID_SPEsCount',
    'DISPID_SpeechObjectToken', 'DISPID_SVSVisemeId',
    'DISPID_SVESentenceBoundary', 'SINone', 'SVESentenceBoundary',
    'DISPID_SVSPhonemeId', 'DISPID_SVStatus', 'DISPID_SRCEBookmark',
    'DISPID_SVGetAudioInputs', 'SPWORD', 'SRAImport', 'ISpProperties',
    'tagSTATSTG', 'ISpResourceManager', 'SP_VISEME_2',
    'SDA_No_Trailing_Space', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SRCSetAdaptationData', 'SPXRO_SML', 'SPSHT_NotOverriden',
    'ISpeechTextSelectionInformation', 'SVEAllEvents',
    'SpInprocRecognizer', 'DISPID_SGRSTWeight',
    'DISPID_SpeechRecoResultTimes', 'SpObjectToken', 'SPRULE',
    'SpUnCompressedLexicon', 'ISpeechAudio', 'ISpeechBaseStream',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SGRsItem',
    'UINT_PTR', 'SREStreamEnd', 'SP_VISEME_14', 'SPVPRIORITY',
    'DISPID_SAEventHandle', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SRCCreateGrammar', 'DISPID_SGRsCount',
    'DISPID_SRGDictationUnload', 'DISPID_SOTs_NewEnum',
    'DISPID_SVWaitUntilDone', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SPSNotOverriden', 'DISPID_SRCRetainedAudio',
    'DISPID_SRCEventInterests', 'SpStream', 'DISPID_SLPSymbolic',
    'SAFT12kHz16BitMono', 'DISPID_SPRulesItem', 'SPEI_MAX_TTS',
    'DISPID_SPPName', 'SAFT11kHz16BitMono', 'SECFIgnoreCase',
    'SPLEXICONTYPE', 'DISPID_SGRAttributes', 'SVSFDefault',
    'SPPROPERTYINFO', 'DISPID_SPPChildren', 'SPINTERFERENCE_TOOLOUD',
    'SVSFUnusedFlags', 'SPEVENTENUM', 'DISPID_SpeechMMSysAudio',
    'DISPID_SPIGrammarId', 'SPWF_SRENGINE', 'SpeechCategoryVoices',
    'SPVPRI_ALERT', 'SpeechRuleAttributes',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SGRSTransitions',
    'DISPID_SVEStreamStart', 'SPSMF_SAPI_PROPERTIES',
    'DISPID_SPIAudioStreamPosition', 'SVP_20', 'ISpeechFileStream',
    'SpeechPropertyNormalConfidenceThreshold',
    'ISpStreamFormatConverter', 'eLEXTYPE_RESERVED8', 'SVEPhoneme',
    'SECFEmulateResult', 'SLTApp', 'DISPID_SPEAudioTimeOffset',
    'ISpMMSysAudio', 'DISPID_SpeechAudioBufferInfo',
    'ISpeechGrammarRule', 'DISPID_SpeechPhraseProperties',
    'eWORDTYPE_DELETED', 'DISPID_SVSLastStreamNumberQueued',
    'SFTInput', 'DISPIDSPRG', 'DISPID_SRCERecognition',
    'SPINTERFERENCE_NONE', 'SPPHRASEPROPERTY', 'eLEXTYPE_APP',
    'SGRSTTWord', 'ISpObjectWithToken', 'ISpPhoneConverter',
    'DISPID_SRGCmdSetRuleIdState', 'SPWAVEFORMATTYPE',
    'SpeechVoiceSkipTypeSentence', 'SAFTExtendedAudioFormat',
    'Speech_Default_Weight', 'DISPID_SWFEBitsPerSample',
    'SPEI_WORD_BOUNDARY', 'ISpeechPhraseReplacement',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SPAsCount', 'SGLexical',
    'SpeechRegistryUserRoot', 'DISPID_SPRNumberOfElements',
    'SPWORDPRONUNCIATIONLIST', 'ISpeechPhraseProperties',
    'DISPID_SpeechPhraseElement', 'DISPID_SOTRemoveStorageFileName',
    'SPPHRASEELEMENT', 'SPSUnknown', 'SPXRO_Alternates_SML',
    'SGSExclusive', 'DISPID_SABIEventBias', 'DISPID_SMSALineId',
    'DISPID_SRState', 'DISPID_SPPsItem', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SGRSTPropertyName', 'DISPID_SpeechVoice',
    'ISpeechLexiconPronunciations', 'SVSFParseAutodetect',
    'DISPID_SLGetWords', 'SAFTGSM610_8kHzMono',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SLAddPronunciation',
    'SPSMF_UPS', 'DISPID_SPEPronunciation', 'SPBINARYGRAMMAR',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SASPause',
    'DISPID_SRRPhraseInfo', 'SPPS_Noncontent', 'SPEVENT',
    'SP_VISEME_9', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SOTCGetDataKey', 'eLEXTYPE_PRIVATE10', 'DISPID_SRGState',
    'DISPID_SVEWord', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'SPPS_Unknown', 'SAFT16kHz16BitStereo', 'SPSHORTCUTPAIR',
    'SVF_Emphasis', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SVEPhoneme', 'DISPID_SRGDictationLoad',
    'SpeechPropertyResponseSpeed', 'SpeechAudioProperties',
    'DISPID_SRGDictationSetState', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SRSClsidEngine', 'ISpAudio', 'DISPID_SRGSetTextSelection',
    'SPAUDIOOPTIONS', 'SpResourceManager', 'SPEI_MAX_SR',
    'SPRST_ACTIVE', 'DISPID_SPPNumberOfElements', 'DISPID_SPPParent',
    'SpeechRecognizerState', 'DISPID_SRCRecognizer',
    'DISPID_SVSInputSentenceLength', 'SPRECOGNIZERSTATUS',
    'SPSInterjection', 'DISPID_SMSGetData', 'SVF_Stressed',
    'SpMMAudioEnum', 'eLEXTYPE_RESERVED10',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SLWPronunciations',
    'SPAS_CLOSED', 'SRAInterpreter', 'SGDSInactive',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SDKGetlongValue', 'WAVEFORMATEX', 'SVEAudioLevel',
    'SREStreamStart', 'SLOStatic', 'DISPID_SVEViseme',
    'DISPID_SpeechPhoneConverter', '_SPAUDIOSTATE', 'DISPID_SGRsAdd',
    'SpPhoneticAlphabetConverter', 'DISPID_SGRSTsItem', 'SP_VISEME_5',
    'SPPHRASEREPLACEMENT', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SOTDisplayUI', 'ISpeechPhraseAlternate', 'SPPS_LMA',
    'SpeechTokenKeyUI', 'SVPOver', 'DISPID_SPRDisplayAttributes',
    'SpeechAudioFormatGUIDText', 'DISPID_SDKDeleteValue',
    'DISPID_SpeechPhraseProperty', 'DISPID_SVResume',
    'ISpeechRecoResult2', 'DISPID_SPCLangId',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SGRSTNextState',
    'DISPID_SVAudioOutput', 'SpeechGrammarWordType',
    'DISPID_SRGetRecognizers', 'DISPID_SRSCurrentStreamNumber',
    'ISpXMLRecoResult', 'SAFT24kHz16BitMono',
    'DISPID_SVSInputWordPosition', 'DISPID_SRCERequestUI',
    'SRCS_Enabled', 'SPFM_CREATE', 'DISPID_SpeechRecognizer',
    'SPEI_ADAPTATION', 'SAFTCCITT_uLaw_8kHzMono',
    'SREPropertyStringChange', 'DISPID_SPPs_NewEnum', 'SPGS_DISABLED',
    'DISPID_SLWsCount', 'ISpVoice',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SPIRetainedSizeBytes',
    'SDTProperty', 'DISPID_SRSSupportedLanguages',
    'SPCT_SUB_DICTATION', 'DISPID_SGRsDynamic', 'SASRun',
    'SAFTCCITT_ALaw_11kHzStereo', 'SpeechAudioState',
    'DISPID_SVSpeakCompleteEvent', 'SRADynamic',
    'DISPID_SPCIdToPhone', 'DISPID_SMSSetData', 'SPWT_DISPLAY',
    'ISpEventSink', 'SAFTADPCM_11kHzMono', 'SPVISEMES', 'SVP_18',
    'SREAudioLevel', 'SpeechLoadOption', 'SDA_Two_Trailing_Spaces',
    'DISPID_SVSpeak', 'SPINTERFERENCE_TOOFAST', 'SPBO_NONE',
    'SRCS_Disabled', 'ISpRecognizer3', 'SAFT24kHz8BitMono',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SRAudioInputStream',
    'DISPID_SPPId', 'SVP_10', 'SPRECOSTATE',
    'SpeechSpecialTransitionType', 'SWPUnknownWordUnpronounceable',
    'DISPIDSPTSI', 'DISPID_SOTCSetId', 'SDKLCurrentUser',
    'DISPID_SGRSTsCount', 'SPEI_VISEME', 'SRESoundStart',
    'SPWORDPRONOUNCEABLE', 'SREPropertyNumChange', 'SpeechRunState',
    'SPCT_COMMAND', 'SPSHT_Unknown', 'SPPS_NotOverriden',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPSHT_EMAIL', 'DISPID_SLPType',
    'SPAUDIOBUFFERINFO', 'SP_VISEME_11', 'SPSHT_OTHER',
    'SPEI_RESERVED3', 'SVP_7', 'DISPID_SRRTTickCount',
    'SAFT16kHz8BitStereo', 'SpeechPropertyComplexResponseSpeed',
    'SPEI_UNDEFINED', 'SpeechRecoEvents',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SGDisplay',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SBSWrite',
    'SVSFParseSsml', 'SP_VISEME_12', 'DISPID_SVIsUISupported',
    'SPRS_INACTIVE', 'DISPID_SAFSetWaveFormatEx', 'IStream',
    'SpeechDataKeyLocation', 'SPVPRI_NORMAL', 'SECFNoSpecialChars',
    'SPSEMANTICFORMAT', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SAFTGSM610_22kHzMono', 'SPEI_HYPOTHESIS', 'DISPID_SRGRules',
    'DISPID_SPIEngineId', 'SVSFVoiceMask', 'SRSInactive', 'LONG_PTR',
    'IEnumString', 'DISPID_SBSFormat', 'DISPID_SRCBookmark',
    'SpLexicon', 'DISPID_SPRuleParent', 'ISpNotifyTranslator',
    '_ISpeechVoiceEvents', 'DISPID_SDKGetBinaryValue',
    'SVEWordBoundary', 'Library', 'SPAS_STOP', 'SRESoundEnd',
    'SAFTADPCM_22kHzMono', 'SAFT8kHz8BitMono',
    'DISPID_SpeechLexiconWords', 'DISPID_SMSAMMHandle',
    'DISPID_SPRsItem'
]

_check_version('1.4.1', 1718721822.005550)
